...
__all__ = ['ResNet', 'resnettiny','resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152', 'resnet_custom']
...
def resnettiny(pretrained=False, **kwargs):
    """
    ...
    model = ResNet(Block, [1, 1, 1], **kwargs)
    if pretrained:
